...
function Boot({ onBegin, hasPlan, theme, onThemeToggle }) {
  ...
  return(
    <div style={{background:"#0a0800",minHeight:"100vh",position:"relative",overflowX:"hidden",overflowY:"auto",fontFamily:"'Inter',sans-serif",cursor:"none"}}>
      ...
      <div style={{opacity:mainVisible?1:0,pointerEvents:mainVisible?"auto":"none",transition:"opacity .7s",position:"relative"}}>
        ...
        {/* ── SECTION 0: Hero ── */}
        <section style={{minHeight:"100vh",position:"relative",zIndex:2,display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",textAlign:"center",padding:"clamp(40px,6vh,70px) clamp(24px,6vw,90px)",overflow:"visible"}}>
          {/* H-rules */}
